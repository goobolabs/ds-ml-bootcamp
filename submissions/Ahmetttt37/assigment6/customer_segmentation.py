...
CSV_PATH = r"C:\Users\Ali Black\Desktop\bootcamp1\ds-ml-bootcamp\submissions\Ahmetttt37\assigment6\raw_wholesale_customers.csv"
OUT_PATH = r"C:\Users\Ali Black\Desktop\bootcamp1\ds-ml-bootcamp\submissions\Ahmetttt37\assigment6\segmented_wholesale_customers.csv"
...
# --------------------------------
# 7.5) Second Clustering Algorithm (Agglomerative)
# --------------------------------
print("\n=== SECOND CLUSTERING: AGGLOMERATIVE ===")

agg = AgglomerativeClustering(n_clusters=K)

agg_labels = agg.fit_predict(X_scaled)

df["AgglomerativeCluster"] = agg_labels.astype(int)
...
if sil > agg_sil:
    print("KMeans produced better separated clusters.")
elif agg_sil > sil:
    print("Agglomerative produced better separated clusters.")
else:
    print("Both methods produced similar cluster separation.")
...
sanity = df.loc[
    ...
    [
        ...
        "Frozen", "Detergents_Paper", "Delicassen", "Cluster",  "AgglomerativeCluster"
    ]
]
...
# Reason:
# Agglomerative Clustering groups customers based on similar spending patterns by merging the closest clusters step by step. It is suitable for wholesale customer segmentation because it naturally groups customers with similar purchasing behavior.
