...
### Third Classifier: K-Nearest Neighbors (KNN)
...
print_clf_metrics("K-Nearest Neighbors (KNN)",y_test,knn_preds,pos_label=1)
print_confmat("K-Nearest Neighbors (KNN)",y_test,knn_preds)
...
print("y_true =", y_true)
print("label_str =", label_str(y_true))
...
print(f"  K-Nearest Neighbors(KNN)      : {label_str(int(knn_model.predict(x_one_df)[0]))}")
